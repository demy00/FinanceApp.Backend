...
public class CategoryTests
{
    ...
    public void Rename_ShouldThrowException_WhenCategoryIsPredefined()
    {
        ...
        Assert.Equal("Predefined categories cannot be renamed.", ex.Message);
    }
    ...
    [Fact]
    public void Delete_ShouldSetIsDeletedToTrue_WhenCategoryIsUserDefined()
    {
        var userId = Guid.NewGuid();
        var category = new Category("Work", "Work expenses", userId);
    ...
    [Fact]
    public void Delete_ShouldThrowException_WhenCategoryIsPredefined()
    {
        var category = new Category(Guid.NewGuid(), "Groceries", "Predefined Category", null);

        var ex = Assert.Throws<InvalidOperationException>(() => category.Delete());
        Assert.Equal("Predefined categories cannot be deleted.", ex.Message);
    }
    ...
    public void DefaultCategories_ShouldBeImmutable()
    {
        ...
        Assert.Throws<InvalidOperationException>(() => category.Delete());
