...
public class GetBillsQueryValidatorTests
{
    private readonly GetBillsQueryValidator _validator;

    public GetBillsQueryValidatorTests()
    {
        _validator = new GetBillsQueryValidator();
    }
