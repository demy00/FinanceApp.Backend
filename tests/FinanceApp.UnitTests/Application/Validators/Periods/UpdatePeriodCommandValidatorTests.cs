...
public class UpdatePeriodCommandValidatorTests
{
    private readonly UpdatePeriodCommandValidator _validator;

    public UpdatePeriodCommandValidatorTests()
    {
        _validator = new UpdatePeriodCommandValidator();
    }
