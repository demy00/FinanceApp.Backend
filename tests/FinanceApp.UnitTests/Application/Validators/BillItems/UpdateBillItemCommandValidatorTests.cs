...
public class UpdateBillItemCommandValidatorTests
{
    private readonly UpdateBillItemCommandValidator _validator;

    public UpdateBillItemCommandValidatorTests()
    {
        _validator = new UpdateBillItemCommandValidator();
    }
